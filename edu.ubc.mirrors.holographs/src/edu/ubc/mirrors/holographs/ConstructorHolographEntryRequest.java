...
public class ConstructorHolographEntryRequest implements ConstructorMirrorHandlerRequest, MirrorInvocationHandler {
    ...
    private final Callback<MirrorEvent> entryCallback = new Callback<MirrorEvent>() {
        ...
        public MirrorEvent handle(MirrorEvent t) {
            ...
            final ConstructorMirrorHandlerEvent handlerEvent = new ConstructorHolographHandlerEvent(ConstructorHolographEntryRequest.this, 
                    entryEvent.thread(), entryEvent.constructor(), entryEvent.isConstructorChaining(), entryEvent.arguments(), ConstructorHolographEntryRequest.this);
            
            handlerEvent.setProceed(ConstructorHolographEntryRequest.this);
            vm.dispatch().raiseEvent(handlerEvent);
            return t;
        }
    };
    
    public ConstructorHolographEntryRequest(VirtualMachineHolograph vm) {
        this.vm = vm;
