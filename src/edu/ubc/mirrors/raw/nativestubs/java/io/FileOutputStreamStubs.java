...
public class FileOutputStreamStubs {

    public static void writeBytes(Class<?> classLoaderLiteral, Mirage fos, Mirage b, int off, int len, boolean append) throws IOException {
