    ...
    public void visitMethodInsn(int opcode, String owner, String name, String desc) {
        ...
        if (name.equals("toString") && desc.equals(Type.getMethodDescriptor(stringMirageType))) {
            if (owner.equals(Type.getInternalName(Mirage.class))) {
                ...
                // There's an odd case in MethodAccessorGenerator generated bytecode of calling
                // Object.toString() with an invokespecial opcode, which doesn't work any more
                // since we've changed the superclass.
